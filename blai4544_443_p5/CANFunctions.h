...
/* This is the CAN1 FIFO message area.	*/
    #define CAN1_CHANNELS       2	// Number of "channels" ("FIFO" in FRM)
    #define CAN1_FIFO_BUFFERS   8	// Depth of each
    #define CAN1_MSG_BUFF_SIZE  16	// Width of each
...
/* This is the CAN2 FIFO message area.	*/
    #define CAN2_CHANNELS       2	// Number of channels (FIFOs in FRM)
    #define CAN2_FIFO_BUFFERS   8	// Depth of each
    #define CAN2_MSG_BUFF_SIZE  16	// Width of each
 ...
 *  Example:  CAN1RxMsgProcess();
  ***************************************************************************/
unsigned int CAN1RxMsgProcess( unsigned int*, unsigned int*, unsigned char*);
 ...
 * Example:   CAN1TxSendLEDMsg();
  ***************************************************************************/
void CAN1TxSendMsg(unsigned char, short unsigned int);
 ...
 * Example:    CAN2TxSendLEDMsg();
  ***************************************************************************/
void CAN2TxSendMsg( unsigned int, unsigned int, unsigned char);
